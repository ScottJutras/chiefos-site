...
export async function GET(req: Request) {
  try {
    ...
    const r = await fetch(
      `${url}/rest/v1/tasks?select=id,title,body,status,type,assigned_to,created_at,updated_at,due_at,completed_at,job_no,task_no&owner_id=eq.${encodeURIComponent(
        ownerId
