    ...
    <div className="mx-auto max-w-6xl py-2">
      ...
      <div className="mb-6 rounded-[28px] border border-[var(--gold-border)] bg-white/[0.04] p-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <div className="text-xs uppercase tracking-[0.18em] text-[var(--text-faint)]">Work</div>
          ...
          <Link
            href="/app/jobs/new"
            className="inline-flex items-center justify-center rounded-2xl bg-[var(--gold)] px-4 py-2.5 text-sm font-semibold text-black hover:opacity-90 transition"
          >
            + Create job
          </Link>
        </div>
