...
export default function DashboardPage() {
  ...
  return (
    <main className="min-h-screen">
      {/* IMPORTANT: layout already constrains width, so we don't add another max-w wrapper here */}
      <div className="py-6">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Commands tile (premium + discoverable) */}
          <Card
        ...
        <div className="mt-6 text-xs text-white/45">
          Tip: Activity is where day-to-day logging lives. Settings is where your system configuration and reference lives.
        </div>
      </div>
    </main>
  );
