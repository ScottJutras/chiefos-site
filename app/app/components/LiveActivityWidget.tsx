  ...
  return (
    <section className="rounded-2xl border border-emerald-500/20 bg-emerald-500/[0.06] p-4">
      ...
      <div className="space-y-2">
        {shifts.map((s) => (
          <div key={s.id} className="flex items-center justify-between rounded-xl bg-black/30 px-3 py-2">
            <div>
            ...
            <span className="text-xs tabular-nums text-emerald-400">{elapsed(s.start_at_utc)}</span>
          </div>
        ))}
      </div>
    </section>
